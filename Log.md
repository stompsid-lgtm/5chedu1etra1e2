...
✅ **22/22 間全部有資料（2026-02-18 完成）**，總計 239 sessions。

| ID  | 診所       | 來源      | 狀態          |
|-----|------------|-----------|---------------|
| c01 | 禾安復健科 | Facebook  | ✓ 已建立      |
| c09 | 健維骨科   | Facebook  | ✓ 已建立      |
| c10 | 板橋維力   | website   | ✓ 已建立（原標 linevoom，實為 weili-clinic.com 固定班表，source_type 已更正） |
| c12 | 陳正傑骨科 | Facebook  | ✓ 已建立      |
| c17 | 仁祐骨科   | Facebook  | ✓ 已建立      |
| c22 | 順安復健科 | Facebook  | ✓ 已建立      |
...
### 無（2026-02-18 首週資料全部完成）

### 已知待確認（下週更新時處理）
- **c01 禾安**：FB 圖片醫師名「陳柏誠醫師」帶後綴，目前以「陳柏誠」建入；若 app 顯示異常需確認 whitelist 字串
- **c11/c10 輪診**：土城/板橋維力週六下午輪診，本週值班醫師未確認，暫無資料
- **c12 陳正傑**：FB 貼文為 2023 年固定班表，doctor_name「陳正傑」為推測，需核對
